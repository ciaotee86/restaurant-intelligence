...
import { X, Link2, ArrowRight, Loader2, CheckCircle2, AlertCircle, Sparkles } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-bold text-[#18181B] tracking-tight">
                Phân tích quán mới từ link Foody
              </h3>
              <p className="text-[11px] text-[#71717A]">
                Thu thập và phân tích cảm xúc đa khía cạnh thời gian thực
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="https://www.foody.vn/da-nang/com-chien-gion-gia-vinh"
                disabled={status === 'crawling' || status === 'analyzing'}
          ...
          {status === 'crawling' && (
            <div className="p-3.5 bg-orange-50 border border-orange-200/80 rounded-lg flex items-center gap-3 text-xs text-orange-900">
              ...
              <div>
                <p className="font-semibold">Đang cào dữ liệu từ Foody & gọi Gemini AI...</p>
                <p className="text-[11px] text-orange-800/80 mt-0.5">Selenium đang cuộn trang trích xuất review và phân tích 5 khía cạnh.</p>
              </div>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="p-3.5 bg-emerald-50 border border-emerald-200 rounded-lg flex items-center gap-3 text-xs text-emerald-900">
              ...
              <div>
                ...
                <p className="text-[11px] text-emerald-800/80 mt-0.5">Đang chuyển hướng tới trang dashboard của quán...</p>
              </div>
            </div>
          )}
          ...
          <div className="pt-3 border-t border-zinc-100 flex items-center justify-end gap-2">
            ...
            <button
              type="submit"
              disabled={status === 'crawling' || status === 'analyzing' || !url.trim()}
